...
class DataDsgs {
  ...
  factory DataDsgs.fromJson(Map<String, dynamic> json) => DataDsgs(
    ugsId: json["ugs_id"] == null ? null : json["ugs_id"],
        ...
        ugsCity: json["ugs_city"] == null ? '' : json["ugs_city"],
        citName: json["cit_name"] == null ? null : json["cit_name"],
        ugsCounty: json["ugs_county"] == null ? null : json["ugs_county"],
        cityDetailName: json["city_detail_name"] == null ? [] : List<String>.from(json["city_detail_name"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() =>
      {
        ...
        "as_name": asIdName == null ? null : List<dynamic>.from(asIdName.map((x) => x)),
