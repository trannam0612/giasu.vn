...
//
//     final resultNote = resultNoteFromJson(jsonString);

import 'dart:convert';

ResultNote resultNoteFromJson(String str) => ResultNote.fromJson(json.decode(str));

String resultNoteToJson(ResultNote data) => json.encode(data.toJson());
...
class ResultNote {
  ...
  factory ResultNote.fromJson(Map<String, dynamic> json) => ResultNote(
