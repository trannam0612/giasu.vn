...
//
//     final resultGetInfoPost = resultGetInfoPostFromJson(jsonString);

import 'dart:convert';

ResultGetInfoPost resultGetInfoPostFromJson(String str) => ResultGetInfoPost.fromJson(json.decode(str));

String resultGetInfoPostToJson(ResultGetInfoPost data) => json.encode(data.toJson());

class ResultGetInfoPost {
  ResultGetInfoPost({
    this.data,
    this.error,
  });
  ...
  factory ResultGetInfoPost.fromJson(Map<String, dynamic> json) => ResultGetInfoPost(
...
class ResultGetInfoPostData {
  ResultGetInfoPostData({
    this.result,
    this.message,
    this.data,
  });
  ...
  factory ResultGetInfoPostData.fromJson(Map<String, dynamic> json) => ResultGetInfoPostData(
