                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text('Gia sư', style: AppTextStyles.regularW400(context, size: AppDimens.textSize20, color: AppColors.whiteFFFFFF),),
                          ),
                        ],
                      ),
                    ),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.symmetric(vertical: AppDimens.space6),
                            child: Text('Phụ huynh', style: AppTextStyles.regularW400(context, size: AppDimens.textSize20, color: AppColors.whiteFFFFFF),),
                          ),
                        ],
                      ),
                    ),
